  ...
  if (btnfind.addEventListener) {
    btnfind.addEventListener(
      ...
      function () {
        ...
        tag =
          document.frmclass.selelement[
            document.frmclass.selelement.selectedIndex
          ].value;
        alert(
          "Se han encontrado " +
            findClassInElements(classname, tag) +
            " elementos " +
            tag.toString() +
            " con la clase " +
            classname
    ...
    btnfind.attachEvent("onclick", function () {
      ...
      classname = document.frmclass.txtname.value;
      tag =
        document.frmclass.selelement[document.frmclass.selelement.selectedIndex]
          .value;
      alert(
        "Se han encontrado " +
          findClassInElements(classname, tag) +
